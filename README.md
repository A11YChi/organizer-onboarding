...
- Email: for communication between organizers and external individuals or groups. **Note:** As of Dec. 17, 2018, we have transitioned to using the A11YChi Gmail account ( a11ychi.meetup@gmail.com ), so it can be shared between organizers when interacting with external folks.
...
As much as we love having individuls participate in this groups success, othertimes, individuals need to leave the group, due to a change in life priorities, moving, or possibly an overwhelming, unreconcileable difference. We want to ensure that no one leave with any bad feelings
...
| Venue Booking                | 1) Find and contact a venue to host a meetup talk; 2) Ensure an [accessibility experience](https://github.com/A11YChi/Venue-Checklist) at the venue | Karen (Primary); others   |
| Speaker Booking              | Locate, set up and help speakers become familiar with how A11YChi meetups work, e.g. sharing the [guideline on accessible presentations](https://github.com/A11YChi/A11Y-Presentations) | Karen (Primary); others   |
